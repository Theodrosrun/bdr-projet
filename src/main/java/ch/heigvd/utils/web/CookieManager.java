...
public class CookieManager {
    ...
    public static boolean mustLogin(HttpServletRequest req) {
        ...
        return usernameCookie =package ch.heigvd.utils.web;
...
import jakarta.servlet.http.HttpServletResponse;
        ...
        public class CookieManager {
             ...
             */
            public static boolean mustLogin(HttpServletRequest req) {
                Cookie usernameCookie =  ch.heigvd.utils.web.CookieManager.getCookie(req, "username");
                Cookie passwordCookie = ch.heigvd.utils.web.CookieManager.getCookie(req, "password");
