...
SELECT c.membre_id,
       ...
       CASE WHEN SUM(CASE WHEN f.datePaiement IS NOT NULL THEN f.montant ELSE 0 END) = f.montant * c.frequencepaiement THEN true ELSE false END AS toutes_factures_payees
FROM Contrat c
